  ...
  return (
    ...
    <div className="container px-5 py-24 mx-auto">
      <div className="flex flex-col text-center w-full mb-12">
        ...
        <p className="lg:w-2/3 mx-auto leading-relaxed text-base">Hey! We are here to help just drop your message</p>
      </div>
      <div className="lg:w-1/2 md:w-2/3 mx-auto">
        <div className="flex flex-wrap -m-2">
          ...
          <div className="p-2 w-full pt-8 mt-8 border-t border-gray-200 text-center">
            <a className="text-red-500">strokyy@email.com</a>
            ...
            <span className="inline-flex">
              ...
              <a className="ml-4 text-gray-500">
                <svg fill="currentColor" strokeLinecap="round" strokeLinejoin="round" stroke-width="2" class="w-5 h-5" viewBox="0 0 24 24">
